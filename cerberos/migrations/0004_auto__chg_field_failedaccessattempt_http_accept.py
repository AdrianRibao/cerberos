...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FailedAccessAttempt.http_accept'
        db.alter_column('cerberos_failedaccessattempt', 'http_accept', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'FailedAccessAttempt.http_accept'
        db.alter_column('cerberos_failedaccessattempt', 'http_accept', self.gf('django.db.models.fields.CharField')(max_length=255))
